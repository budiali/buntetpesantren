...
<head>
  ...
  <!-- Theme style -->
   <link rel="stylesheet" href="<?php echo base_url('assets/LTE/')?>plugins/datatables/dataTables.bootstrap4.min.css">
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/LTE/plugins/daterangepicker/daterangepicker-bs3.css'?>">
